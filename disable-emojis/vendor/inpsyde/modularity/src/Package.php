...
namespace RyanHellyer\DisableEmojis\Vendor\Inpsyde\Modularity;

use RyanHellyer\DisableEmojis\Vendor\Inpsyde\Modularity\Container\ContainerConfigurator;
use RyanHellyer\DisableEmojis\Vendor\Inpsyde\Modularity\Container\PackageProxyContainer;
use RyanHellyer\DisableEmojis\Vendor\Inpsyde\Modularity\Module\ExecutableModule;
use RyanHellyer\DisableEmojis\Vendor\Inpsyde\Modularity\Module\ExtendingModule;
use RyanHellyer\DisableEmojis\Vendor\Inpsyde\Modularity\Module\FactoryModule;
use RyanHellyer\DisableEmojis\Vendor\Inpsyde\Modularity\Module\Module;
use RyanHellyer\DisableEmojis\Vendor\Inpsyde\Modularity\Module\ServiceModule;
use RyanHellyer\DisableEmojis\Vendor\Inpsyde\Modularity\Properties\Properties;
...
class Package
{
    ...
    private function handleConnectionFailure(string $packageName, string $reason, bool $throw): bool
    {
        ...
        do_action($this->hookName(self::ACTION_FAILED_CONNECT), $packageName, new \RyanHellyer\DisableEmojis\Vendor\WP_Error('failed_connection', $message, $errorData));
        if ($throw) {
